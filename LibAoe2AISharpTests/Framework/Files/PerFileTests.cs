...
namespace LibAoe2AISharp.Framework.Tests
{
    ...
    public class PerFileTests
    {
        ...
        {
            // Arrange
            var expectedOutputScript = ";Age of Empires II Computer Player Strategy" + Environment.NewLine +
                ";Generated by Aoe2AIEditor: LibAoe2AISharp:Ver.0.0.0.1" + Environment.NewLine +
                ";File: TestAIFile" + Environment.NewLine +
                ";Author: author name" + Environment.NewLine +
                ";Date: 2020/03/12 20:55:29" + Environment.NewLine +
                ";===========================================================================...";
